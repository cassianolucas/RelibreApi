...
namespace RelibreApi.Migrations
{
    ...
    [Migration("20201005223717_SQL_0005")]
    partial class SQL_0005
    {
            ...
            modelBuilder.Entity("RelibreApi.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2020, 10, 5, 19, 37, 16, 0, DateTimeKind.Unspecified),
                            Name = "PJ",
                            UpdatedAt = new DateTime(2020, 10, 5, 19, 37, 16, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 2L,
