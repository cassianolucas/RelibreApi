...
namespace RelibreApi.Migrations
{
    ...
    [Migration("20201116233156_SQL_005")]
    partial class SQL_005
    {
            ...
            modelBuilder.Entity("RelibreApi.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 729, DateTimeKind.Local).AddTicks(9281),
                            Name = "PJ",
                            UpdatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 730, DateTimeKind.Local).AddTicks(6440)
                        },
                        new
                        {
                            Id = 2L,
                            Active = true,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 730, DateTimeKind.Local).AddTicks(6816),
                            Name = "PF",
                            UpdatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 730, DateTimeKind.Local).AddTicks(6826)
                        });
                });
            ...
            modelBuilder.Entity("RelibreApi.Models.Type", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 731, DateTimeKind.Local).AddTicks(6042),
                            Description = "Trocar",
                        ...
                        new
                        {
                            Id = 2L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 731, DateTimeKind.Local).AddTicks(6081),
                            Description = "Doar",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 731, DateTimeKind.Local).AddTicks(6084),
                        ...
                        new
                        {
                            Id = 4L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 731, DateTimeKind.Local).AddTicks(6085),
                        ...
                        new
                        {
                            Id = 5L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 16, 20, 31, 55, 731, DateTimeKind.Local).AddTicks(6086),
                            Description = "Venda",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
