...
namespace RelibreApi.Migrations
{
    ...
    [Migration("20201120224019_SQL_010")]
    partial class SQL_010
    {
            ...
            modelBuilder.Entity("RelibreApi.Models.Profile", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = true,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 378, DateTimeKind.Local).AddTicks(9815),
                            Name = "PJ",
                            UpdatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 379, DateTimeKind.Local).AddTicks(5741)
                        },
                        new
                        {
                            Id = 2L,
                            Active = true,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 379, DateTimeKind.Local).AddTicks(6064),
                            Name = "PF",
                            UpdatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 379, DateTimeKind.Local).AddTicks(6075)
                        });
                });
            ...
            modelBuilder.Entity("RelibreApi.Models.Subscription", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(5785),
                        ...
                        {
                            Id = 2L,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(5830),
                        ...
                        {
                            Id = 3L,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(5833),
            ...
            modelBuilder.Entity("RelibreApi.Models.Type", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(4661),
                            Description = "Trocar",
                        ...
                        new
                        {
                            Id = 2L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(4696),
                            Description = "Doar",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            Id = 3L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(4698),
                        ...
                        new
                        {
                            Id = 4L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(4700),
                        ...
                        new
                        {
                            Id = 5L,
                            Active = false,
                            CreatedAt = new DateTime(2020, 11, 20, 19, 40, 19, 380, DateTimeKind.Local).AddTicks(4701),
                            Description = "Venda",
                            UpdatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
